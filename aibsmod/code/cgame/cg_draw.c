...
//aibsmod - These need to be declared here
//(else parameter/return type won't be guessed correctly)
static float getPlayerSpeed(void);
static float CG_DrawBigSpeed(float y);
static void CG_DrawSmallSpeed(void);
static void CG_DrawButtons(void);
...
static void CG_DrawWarmup( void ) {
	...
	if (cgs.gametype == GT_TOURNAMENT) {
		...
		if ( cgs.gametype == GT_FFA ) {
			...
			s = "Harvester";
#endif
		//aibsmod - add our gametypes here
...
//aibsmod - custom functions follow...
